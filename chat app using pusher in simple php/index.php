  ...
  <div class="container">
    <div class="header border-bottom border-secondary p-2 d-flex justify-content-between align-items-center">
      <div class="d-flex align-items-center">
        <img src="https://img.freepik.com/free-psd/3d-illustration-person-with-sunglasses_23-2149436188.jpg?w=740&t=st=1707473037~exp=1707473637~hmac=33da704f123eb3a6e884481f0ed94409392fd36cf52bbe7c72cdc85c89de6191" alt="" style="width: 60px;" class="me-3 rounded-circle">
        <div class="h4"><?= $_SESSION['userName'] ?></div>
      </div>
      <a href="logout.php" class="btn btn-danger">Logout</a>
    </div>
    <div class="card mt-3">
      <div class="card-header">
        <div class="h4">Real Time ChatRoom</div>
      </div>
